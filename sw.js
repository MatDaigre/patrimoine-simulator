const CACHE='patrimoine-simulator-v173-mobile-ui';
const ASSETS=[
  './',
  './index.html',
  './mobile.css',
...
const MOBILE_STYLE = [
  '<link rel="stylesheet" href="./mobile.css?v=173" media="(max-width: 720px)">',
  '<link rel="stylesheet" href="./mobile-v2.css?v=173" media="(max-width: 720px)">',
  '<meta name="theme-color" media="(max-width: 720px)" content="#0b1120">',
  '<script defer src="./mobile-nav.js?v=173"></script>'
].join('');
...
async function injectMobileLayer(response) {
  ...
  if (html.includes('mobile-nav.js?v=173')) {
